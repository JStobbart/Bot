...
inline_keyboard_gan = InlineKeyboardMarkup(row_width=4, inline_keyboard=[
    ...
    [
        InlineKeyboardButton(text='summer to winter', callback_data='summer2winter_yosemite_pretrained'),
        InlineKeyboardButton(text='winter to summer', callback_data='winter2summer_yosemite_pretrained')
